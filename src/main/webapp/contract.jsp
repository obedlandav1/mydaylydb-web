    ...
    <body>
        ...
        <section class="col-lg-10 offset-lg-1">
            ...
            <div class="container-fluid">
                ...
                <table style="max-height: 300px; overflow-y: auto;" class="table table-responsive caption-top table-striped" id="tbl-contract">
                        ...
                        <c:if test="${showcontracts}">
                            ...
                            <c:forEach var="c" items="${contracts}">
                                <tr>
                                    ...
                                    <td>${c.tipomoneda}</td>
                                    <td>${c.formapago}</td>
                                    <td><button type="button" data-details='${c.detallepago}' onclick="showdetails(this.dataset.details)" class="btn btn-primary">Ver</button></td>                                   
                                    <!--<td>${c.exonerado}</td>-->
                                    <td>${c.imponible}</td>
                                    <!--<td>${c.impuesto}</td>-->
                                    <td>${c.valortotal}</td>
